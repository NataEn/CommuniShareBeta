    ...
    return (
        <ul className="nav flex-column">
            ...
            <div className="form-check">
                <input className="form-check-input" type="radio" id="availability" value="availability" name='ordering'
                       onChange={handelPickOrdering}/>
                <label className="form-check-label" htmlFor="availability">Availability</label>
            </div>
            <div className="form-check">
                <input className="form-check-input" type="radio" id="date" value="date" name='ordering'
                       onChange={handelPickOrdering}/>
